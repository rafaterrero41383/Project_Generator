...
const newBody = {
  ...
  accountIdentification: body.accountIdentification.map((identification) => ({
    identifierValue: identification.identifierValue,
    accountIdentificationType: identification.accountIdentificationType,
  })),
};
